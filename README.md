...
| | |
|---|---|
| ![Home](docs/screenshots/01-home.png) | ![Report list](docs/screenshots/02-reports.png) |
| ![AI report analysis](docs/screenshots/03-report-analysis.png) | ![Interactive waveform viewer](docs/screenshots/04-report-waveform.png) |
| ![EEG knowledge base](docs/screenshots/05-guide.png) | ![Case library](docs/screenshots/06-cases.png) |
| ![EEG simulator](docs/screenshots/07-simulator.png) | ![Account & settings](docs/screenshots/08-account.png) |
