...
def _build_prompt(a: Dict, level: str, lang: str) -> str:
    ...
    if level == "student":
        return (
            ...
            f"LENGTH: each paragraph must be at least 6 sentences; TOTAL must be at least 550 words. "
            f"A short answer is a FAILURE — expand every paragraph until the length target is met.\n\n"
