...
def _build_prompt(a: Dict, level: str, lang: str) -> str:
    ...
    return (
        ...
        f"TASK: Write a rigorous technical analysis in 3 paragraphs. "
        ...
        f"PARAGRAPH 3 — Signal quality and artifacts: "
        f"Objectively report the signal quality score, the number of noisy channels "
        f"(refer to them by category, not full names), possible_artifacts, clipping_detected, "
        f"high_frequency_noise, and missing_data. State what was found and what was not found. "
        f"Keep this paragraph factual and descriptive — describe the data, do not speculate about "
        ...
        f"- 3 paragraphs, each 3-5 sentences. Dense, precise, zero filler.\n"
        f"{uncertainty}{boundary}\nEEG JSON:\n{payload}\n"
    )
