...
def _build_prompt(a: Dict, level: str, lang: str) -> str:
    ...
    if level == "student":
        return (
            ...
            f"- 3 paragraphs, each 3-4 sentences. Keep it TIGHT — every sentence carries a real number or a "
    ...
    return (
        ...
        f"- 3 paragraphs. Keep it SHORT and DENSE — do NOT pad to reach a word count. "
