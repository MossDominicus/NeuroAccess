...
def _build_prompt(a: Dict, level: str, lang: str) -> str:
    ...
    if level == "student":
        return (
            ...
            f"PARAGRAPH 2 — Brainwave bands in this recording (write AT LEAST 10 sentences): "
            ...
            f"That is 5 bands × 2 sentences = 10 sentences minimum. If gamma is missing or 0 in the JSON "
